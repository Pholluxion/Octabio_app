...
class ProximityView extends StatefulWidget {
  ProximityView({Key? key, required this.device}) : super(key: key);
              ...
              ? Column(
                  children: [
                    double.parse(utf8
                                ...
                                .replaceAll(">", "")) >=
                            1
                        ? Lottie.asset('assets/lottie/radar.json', width: 350)
                        : Lottie.asset('assets/lottie/radar2.json', width: 350),
                    Padding(
